...
# import the training and test data, then scale it into the
# range [0, 1]
...
# convert the labels from integers to binary
lb = LabelBinarizer()
trainY = lb.fit_transform(trainY)
testY = lb.fit_transform(testY)

# initialize the lables names for the CIFAR-10 dataset
