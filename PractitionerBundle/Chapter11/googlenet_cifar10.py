...
from siddhantbansal.nn.conv import MiniGoogLeNet
from siddhantbansal.callbacks import TrainingMonitor
from keras.preprocessing.image import ImageDataGenerator
from keras.callbacks import LearingRateScheduler
...
def poly_decay(epoch):
    # initialize the max number of epochs, base learning rate, and power of the polynomial
