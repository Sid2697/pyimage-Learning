...
# construct the argument parser and parse the argumets
ap = argparse.ArgumentParser()
ap.add_argument('-d', '--dataset', required=True, help='path to input dataset')
args = vars(ap.parse_args())

# grab the list of images that we'll be describing, then extract the class label names from the iamge paths
...
# constrtuct the image ganerator for data augmentation
